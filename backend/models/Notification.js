...
const notificationSchema = new mongoose.Schema({
    ...
    type:      { type: String, enum: ['new_citation', 'new_request', 'application_approved', 'application_rejected', 'reply', 'mention', 'content_removed', 'expert_application'], required: true },
